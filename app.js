...
//     How do we change the value of a variable?
 DogAge = 12; t = 13; const can not be re-assigned.
//     How do we assign an existing variable to a new variable?
 let gg = x;
//     Remind me, what are declare, assign, and define?
 Declare are let,var or const
 Assign is the equal sign(=)
//     What is pseudocoding and why should you do it?
 pseudocoing is a fake code written in human words like a plan out logic before the actual coding. It is the thought process use of plain Englih words that the computer doesn't understand.
//     What percentage of time should be spent thinking about how you're going to solve a problem vs actually typing in code to solve it?
 80% of pseudocoding(thought out process before coding)
 20% for the actual coding.
...
secondVariable = 'Power Book III: Ghost'
...
// C Give Me Five
let afrodance = 'three is a crowd'
let five = 'High five!'
for (let i=1;i<=100;i++) {
 if (!(i%3) && !(i%5)) {
...
let quotes = ["I like to dance","I am a biker"," my dog is potty trained"]
console.log(quotes)
...
// Thom's accessories
 ...
 ristynsCloset[6] = "stained knit hat";
